...
if __name__ == '__main__':
    ...
    '''Data preprocessing.'''
    train_data, test_data = data_preprocessing(anchor, positive, negative)
    ...
    # # visualization result, (positive or negative test)
    # visualization_result(test_input=test_input[0], test_val=test_val[0])

    '''Model save '''
    siamese_model.save('model_weights/complete_model/10.15/')
    print('Save all model done!')